...
# Mac os function
def change_dns_mac(dns1, dns2):
  print("Changing DNS on Mac...")
  subprocess.run(["sudo","ifconfig", "set", "dnsservers", dns1, dns2])

# Linux function :
def change_dns_linux(dns1, dns2):
  print("Changing DNS on Linux...")
...
if platform.system() == "Windows":
    ...
    b = (input("keys:\n"
        ...
        "enter 2 for Google - 8.8.8.8, 8.8.4.4 \n"
        "enter 3 for OpenDNS - 208.67.222.222, 208.67.220.220 \n"
        "enter 4 for AdGuard - 176.103.130.130, 176.103.130.131  \n"
        "enter 5 for Shekan DNS (not recommended) \n"
        "enter 6 for Electro DNS (not recommended) \n"
        "enter 7 for Radar-game DNS (not recommended) \n"
        "\n"
        ":-->>"))
    a = int(b)
    if a == 1 :
        change_dns_mac("1.1.1.1", "1.0.0.1")
        
    elif a == 2 :
        change_dns_mac("8.8.8.8", "8.8.4.4")
        
    elif a == 3 :
        change_dns_mac("208.67.222.222", "208.67.220.220")
        
    elif a == 4 :
        change_dns_mac("176.103.130.130", "176.103.130.131")
    
    elif a == 5 :
        change_dns_mac("178.22.122.100", "185.51.200.2")
        
    elif a == 6 :
        change_dns_mac("78.157.42.100", "78.157.42.101")
        
    elif a == 7 :
        change_dns_mac("10.202.10.10", "10.202.10.11")
    ...
    a = int(b)
    if a == 1 :
        change_dns_linux("1.1.1.1", "1.0.0.1")
        
    elif a == 2 :
        change_dns_linux("8.8.8.8", "8.8.4.4")
        
    elif a == 3 :
        change_dns_linux("208.67.222.222", "208.67.220.220")
        
    elif a == 4 :
        change_dns_linux("176.103.130.130", "176.103.130.131")
    
    elif a == 5 :
        change_dns_linux("178.22.122.100", "185.51.200.2")
        
    elif a == 6 :
        change_dns_linux("78.157.42.100", "78.157.42.101")
        
    elif a == 7 :
        change_dns_linux("10.202.10.10", "10.202.10.11")
